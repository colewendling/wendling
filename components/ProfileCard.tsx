...
const ProfileCard: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row items-stretch text-white space-y-6 lg:space-y-0 lg:space-x-4">
      ...
      {/* Text and icon grid */}
      <div className="flex flex-col justify-between w-full lg:w-1/2 px-4 lg:px-8 space-y-4 lg:max-w-[500px]">
        <p className="text-sm">
        ...
        <TechIconGrid
          icons={[
            { src: "/icons/nextdotjs.svg", name: "Next.js", color: "text-green-400" },
            { src: "/icons/vercel.svg", name: "Vercel", color: "text-white" },
            { src: "/icons/react.svg", name: "React", color: "text-pink-500" },
            { src: "/icons/javascript.svg", name: "JavaScript" },
            { src: "/icons/ruby.svg", name: "Ruby", color: "text-gray-300" },
            { src: "/icons/postgresql.svg", name: "PostgreSQL", color: "text-indigo-500" },
            { src: "/icons/tailwindcss.svg", name: "Tailwind CSS", color: "text-amber-400" },
            { src: "/icons/git.svg", name: "Git", color: "text-yellow-400" },
            { src: "/icons/html5.svg", name: "HTML5", color: "text-blue-500" },
